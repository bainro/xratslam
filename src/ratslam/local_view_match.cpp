                               ...
                               unsigned int image_height )
{
  ...
  // Mesmu
  if ( this->view_rgb ) delete this->view_rgb;
...
void LocalViewMatch::convert_view_to_view_template(bool grayscale)
{
  ...
  /*
  cout << "LocalViewMatch::convert_view_to_view_template() -begin."
       << endl
       << "  sub_range_x         : "<< sub_range_x          << endl
       << "  sub_range_y         : "<< sub_range_y          << endl
       << "  x_block_size        : "<< x_block_size         << endl
       << "  y_block_size        : "<< y_block_size         << endl
       << "  TEMPLATE_X_SIZE     : "<< TEMPLATE_X_SIZE      << endl
       << "  TEMPLATE_Y_SIZE     : "<< TEMPLATE_Y_SIZE      << endl
       << "  IMAGE_VT_X_RANGE_MIN: "<< IMAGE_VT_X_RANGE_MIN << endl
       << "  IMAGE_VT_Y_RANGE_MIN: "<< IMAGE_VT_Y_RANGE_MIN << endl
       << "  VT_NORMALISATION    : "<< VT_NORMALISATION     << endl;
  */
  ...
  {
    //    printf( "LocalViewMatch::convert_view_to_view_template() VT_PATCH_NORMALISATION > 0\n" );
